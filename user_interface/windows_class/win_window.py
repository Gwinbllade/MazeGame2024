...
class WinWindow(Window):
    def show_window(self, score, game_time):
        ...
        win_label = tk.Label(self._current_window_frame,
                             ...
                             font=("Helvetica", 40), wraplength=800, justify="center")
        ...
        # Кнопка "Зберегти"
        save_button = tk.Button(self._current_window_frame, text="Зберегти", font=("Helvetica", 16), command=lambda: (
        UserResults.save_result(name_entry.get(), game_time, score), self._windows["Menu"].show_window()))
